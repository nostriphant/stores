...
use nostriphant\Stores\Engine\Memory,
    nostriphant\Stores\Engine\SQLite,
    nostriphant\Stores\Engine\Disk;

function wrapEngine(\nostriphant\Stores\Engine $engine, array $whitelist_prototypes): nostriphant\Stores\Store {
    return new nostriphant\Stores\Store($engine, $whitelist_prototypes);
}
