...
use nostriphant\Stores\Engine\SQLite;
...
it('filters events', function (array $filter_prototype) {
    ...
    $events = iterator_to_array(nostriphant\Stores\Store::query($store, $filter_prototype));
    expect($sqlite->lastErrorMsg())->toBe('not an error');
...
it('limits events in result set', function () {
    ...
    $events = nostriphant\Stores\Store::query($store, ['ids' => ['07cf455963bffe4ef851e4983df2d1495602714abc6c0e028c02752b16e11bcb'], 'limit' => 1]);
    expect(iterator_count($events))->toBe(1);

    $events = nostriphant\Stores\Store::query($store, ['ids' => ['07cf455963bffe4ef851e4983df2d1495602714abc6c0e028c02752b16e11bcb'], 'limit' => 0]);
