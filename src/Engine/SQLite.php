...
use nostriphant\Stores\Engine;
use nostriphant\Stores\Housekeeper;
...
readonly class SQLite implements Engine {
    ...
    public function query(\nostriphant\Stores\Conditions $conditionsFactory, ?int $limit, string ...$fields): SQLite\Statement {
        $conditionFactory = new \nostriphant\Stores\ConditionFactory(SQLite\Condition\Test::class);
